;(function($, document, window, undefined) {
	...
	$.fn.toMobileMenu = function() {
		...
		$('body').prepend('<a class="mobile-menu">'+syd.t('menu')+' <span class="glyphicon glyphicon-menu-hamburger pull-right"></span></a><div class="mobile-holder"><ul></ul></div><div class="mobile-pad"></div>')
